...
#  Генерируем список закладок формата {номер страницы} - {Начальный текст страницы}
#  в виде инлайн-кнопок (каждая кнопка на новой строке), а также еще две кнопки -
...
# Генерируем список закладок к удалению и кнопку "Отменить"
