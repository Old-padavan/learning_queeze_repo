...
async def process_command_start(message: Message):
    keyboard: list[list[InlineKeyboardButton]] = [[InlineKeyboardButton(
        text='Хочу ещё', callback_data='more')]]
    markup: InlineKeyboardMarkup = InlineKeyboardMarkup(inline_keyboard=keyboard)
    await message.answer(text=jokes[random_joke()],
                         reply_markup=markup)
...
async def process_more_press(callback: CallbackQuery):
    ...
    await callback.message.edit_text(text=jokes[random_joke()],
                                  reply_markup=markup)
